...
console.log("\n")
console.log("ans32")
let current_users: string[] = ["ashhal", "umer", "hamza", "ali", "rayyan"];
let new_users: string[] = ["fariha", "noyan", "bilaj", "adnan", "wasif"];
...
console.log("\n")
console.log("ans35")
const commonAnimals: string[] = ['parrot', 'horse', 'Rabbit'];

for (const pet of commonAnimals) {
    console.log(pet);
}
for (const pet of commonAnimals) {
    console.log(`A ${pet.toLowerCase()} would make a great pet.`);
}
// q36
// 36. T-Shirt:
...
function country_city(country:string, city:string,):string{
    return `${country},${city}`
}
...
const magicianNames: string[] = ["ASHHAL", "Harry ", "BOT", "JERRY"];
...
const magicianNamess: string[] = ["David Copperfield", "Harry Houdini", "Penn Jillette", "Teller"];

const greatMagicianss: string[] = make_greats([...magicianNames]);
